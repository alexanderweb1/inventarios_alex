...
class Database{
    ...
    public function getRecords($tableName, $fields='', $cond='', $orderBy='', $limit='')
    {
        ...
        try {
            ...
            //print "SELECT $fields FROM $tableName WHERE ".$cond." ".$orderBy." ";
            $stmt->execute();
    ...
    public function getAllRecords($tableName, $fields='*', $cond='', $orderBy='', $limit='')
    {
        //echo "SELECT  $tableName.$fields FROM $tableName WHERE 1 ".$cond." ".$orderBy." ".$limit;
        //print "<br>SELECT $fields FROM $tableName WHERE 1 ".$cond." ".$orderBy." ".$limit;
        //echo "<br>SELECT $fields FROM $tableName WHERE 1 ".$cond." ".$orderBy." ".$limit;
        //return;
        try{
            $stmt = $this->pdo->prepare("SELECT $fields FROM $tableName WHERE 1 ".$cond." ".$orderBy." ".$limit);
            //echo "<br> SELECT $fields FROM $tableName WHERE 1 ".$cond." ".$orderBy." ".$limit;
    ...
    public function getAllRecordsJoin($tableName, $fields='', $cond='', $orderBy='', $limit='')
    {
       // echo "SELECT  $tableName.$fields FROM $tableName WHERE 1 ".$cond." ".$orderBy." ".$limit."<br>";
        //print "<br>SELECT $fields FROM $tableName WHERE 1 ".$cond." ".$orderBy." ".$limit;
        //echo "SELECT $fields FROM $tableName WHERE  ".$cond." ".$orderBy." ".$limit."<br>+++++";
    ...
    public function getCountJoin($tableName, $fields='', $cond='', $orderBy='', $limit='')
    {
        //echo "SELECT  $tableName.$fields FROM $tableName WHERE 1 ".$cond." ".$orderBy." ".$limit;
        //print "<br>SELECT $fields FROM $tableName WHERE 1 ".$cond." ".$orderBy." ".$limit;
        try{
    ...
    //Consultar en difentes tablas y devuelve un solo dato
    public function consultaDatos($tableName, $where){
        try{
