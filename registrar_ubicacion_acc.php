...
if ($accion == "EDITAR") {
    ...
    if ($result) {
        ...
        $data    =    array(
            ...
            't_operacion' => "EDITAR",
            'descripcion' => $_SESSION['usuario']->getNombre() . " Datos Actualizados: Nombre= $nombre descripcion= $descripcion fecha= $fecha_final",
        );
    ...
    if ($result) {
        ...
        $data    =    array(
            ...
            'descripcion' => $_SESSION['usuario']->getNombre() . " Datos Insertados: Nombre= $nombre descripcion= $descripcion fecha= $fecha_final",
        );
        $insert    =    $db->insert('auditoria', $data);
        if ($insert) {
            echo ('<br>Auditoria registrada<br>');
